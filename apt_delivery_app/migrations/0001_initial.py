    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='meal.png', upload_to='images', verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_item', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='apt_delivery_app.menuitem', verbose_name='Позиция из меню')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_date', models.TimeField(default=apt_delivery_app.models.m_order.get_default_created_at, verbose_name='Время получения заказа')),
                ...
                ('qr_code', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='QR код для подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_item', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='apt_delivery_app.menuitem', verbose_name='Позиция из меню')),
